...
function Vehiculos() {
  ...
  return (
    <div>
      ...
      <section
        className="bg-cover bg-center text-black px-8 py-32 gap-10 flex flex-col items-center place-content-center"
        style={{ backgroundImage: `url(${azul})` }}
      >
        <div className="mb-10">
          <h2 className="text-6xl text-white font-bold uppercase">Vehiculos</h2>
        </div>
